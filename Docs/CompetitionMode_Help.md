...
![Results](Competition_View.PNG)

...

## $$\color{blue}📑Steps$$

1. First, open the video game Inazuma Eleven Victory Road, and open the competition mode, free match mode (fullscreen mode, in the main screen).
2. Place your cursor over the team you want to play against (do not enter into the difficulty menu)

![Results](CompetitionMode_HowToStart.PNG)

3. Click the "Run Autofarm" button (click on the game screen if it is not focused). You can do **windows + tab** to switch between applications.
4. Check if it's working correctly. If the application didn`t select the Heroic difficulty and the match hasn't started, stop the execution and start again. If it's working correctly, don't move the mouse or switch between applications to avoid any error.
5. Enjoy it!!!
